...
# Form implementation generated from reading ui file 'Goi_mon_tra_sua.ui'
#
...
class Ui_goi_mon_tra_sua(object):
    def setupUi(self, goi_mon_tra_sua):
        goi_mon_tra_sua.setObjectName("goi_mon_tra_sua")
        goi_mon_tra_sua.resize(1031, 811)
        self.centralwidget = QtWidgets.QWidget(goi_mon_tra_sua)
...
"border-left-color: rgb(0, 0, 0);")
        ...
        self.tra_sua_tran_chau = QtWidgets.QPushButton(self.groupBox)
        self.tra_sua_tran_chau.setGeometry(QtCore.QRect(350, 0, 141, 131))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.tra_sua_tran_chau.setFont(font)
        self.tra_sua_tran_chau.setObjectName("tra_sua_tran_chau")
        self.tra_sua_tran_chau_duong_den = QtWidgets.QPushButton(self.groupBox)
        self.tra_sua_tran_chau_duong_den.setGeometry(QtCore.QRect(490, 0, 141, 131))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.tra_sua_tran_chau_duong_den.setFont(font)
        self.tra_sua_tran_chau_duong_den.setObjectName("tra_sua_tran_chau_duong_den")
        self.tra_sua_thach_dua = QtWidgets.QPushButton(self.groupBox)
        self.tra_sua_thach_dua.setGeometry(QtCore.QRect(350, 130, 141, 131))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.tra_sua_thach_dua.setFont(font)
        self.tra_sua_thach_dua.setObjectName("tra_sua_thach_dua")
        self.tra_sua_nuong = QtWidgets.QPushButton(self.groupBox)
        self.tra_sua_nuong.setGeometry(QtCore.QRect(490, 130, 141, 131))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.tra_sua_nuong.setFont(font)
        self.tra_sua_nuong.setObjectName("tra_sua_nuong")
        self.line_3.raise_()
        ...
        self.tra_sua_tran_chau.raise_()
        self.tra_sua_tran_chau_duong_den.raise_()
        self.tra_sua_thach_dua.raise_()
        self.tra_sua_nuong.raise_()
        goi_mon_tra_sua.setCentralWidget(self.centralwidget)

        self.retranslateUi(goi_mon_tra_sua)
        QtCore.QMetaObject.connectSlotsByName(goi_mon_tra_sua)

    def retranslateUi(self, goi_mon_tra_sua):
        _translate = QtCore.QCoreApplication.translate
        goi_mon_tra_sua.setWindowTitle(_translate("goi_mon_tra_sua", "MainWindow"))
        self.check.setText(_translate("goi_mon_tra_sua", "Hóa Đơn"))
        self.exit.setText(_translate("goi_mon_tra_sua", "Đăng Xuất"))
        self.main.setText(_translate("goi_mon_tra_sua", "Trang chủ"))
        self.account.setText(_translate("goi_mon_tra_sua", "Tài Khoản"))
        self.food.setText(_translate("goi_mon_tra_sua", "Gọi Món"))
        self.menu.setText(_translate("goi_mon_tra_sua", "MENU"))
        self.loai_cafe.setText(_translate("goi_mon_tra_sua", "Cafe"))
        self.loai_tra_sua.setText(_translate("goi_mon_tra_sua", "Trà Sữa"))
        self.loai_tra_hoa_qua.setText(_translate("goi_mon_tra_sua", "Trà Hoa Quả"))
        self.loai_kem.setText(_translate("goi_mon_tra_sua", "Kem"))
        self.label_3.setText(_translate("goi_mon_tra_sua", "Tên món"))
        self.label_4.setText(_translate("goi_mon_tra_sua", "Số Lượng"))
        self.label.setText(_translate("goi_mon_tra_sua", "Tổng : "))
        self.tra_sua_tran_chau.setText(_translate("goi_mon_tra_sua", "Trà Sữa Trân Châu\n"
"\n"
"25.000"))
        self.tra_sua_tran_chau_duong_den.setText(_translate("goi_mon_tra_sua", "Trà Sữa Trân Châu \n"
"Đường Đen\n"
"\n"
"25.000"))
        self.tra_sua_thach_dua.setText(_translate("goi_mon_tra_sua", "Trà Sữa Thạch Dừa\n"
"\n"
"25.000"))
        self.tra_sua_nuong.setText(_translate("goi_mon_tra_sua", "Trà Sữa Nướng\n"
"\n"
"25.000"))
...
if __name__ == "__main__":
    ...
    goi_mon_tra_sua = QtWidgets.QMainWindow()
    ui = Ui_goi_mon_tra_sua()
    ui.setupUi(goi_mon_tra_sua)
    goi_mon_tra_sua.show()
    sys.exit(app.exec_())
