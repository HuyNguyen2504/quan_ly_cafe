...
# Form implementation generated from reading ui file 'Goi_mon_kem.ui'
#
...
class Ui_goi_mon_kem(object):
    def setupUi(self, goi_mon_kem):
        goi_mon_kem.setObjectName("goi_mon_kem")
        goi_mon_kem.resize(1031, 811)
        self.centralwidget = QtWidgets.QWidget(goi_mon_kem)
...
"border-left-color: rgb(0, 0, 0);")
        ...
        self.kem_oc_que = QtWidgets.QPushButton(self.groupBox)
        self.kem_oc_que.setGeometry(QtCore.QRect(350, 0, 141, 131))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.kem_oc_que.setFont(font)
        self.kem_oc_que.setObjectName("kem_oc_que")
        self.kem_socola = QtWidgets.QPushButton(self.groupBox)
        self.kem_socola.setGeometry(QtCore.QRect(490, 0, 141, 131))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.kem_socola.setFont(font)
        self.kem_socola.setObjectName("kem_socola")
        self.kem_dau = QtWidgets.QPushButton(self.groupBox)
        self.kem_dau.setGeometry(QtCore.QRect(350, 130, 141, 131))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.kem_dau.setFont(font)
        self.kem_dau.setObjectName("kem_dau")
        self.kem_vani = QtWidgets.QPushButton(self.groupBox)
        self.kem_vani.setGeometry(QtCore.QRect(490, 130, 141, 131))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.kem_vani.setFont(font)
        self.kem_vani.setObjectName("kem_vani")
        self.line_3.raise_()
        ...
        self.kem_oc_que.raise_()
        self.kem_socola.raise_()
        self.kem_dau.raise_()
        self.kem_vani.raise_()
        goi_mon_kem.setCentralWidget(self.centralwidget)

        self.retranslateUi(goi_mon_kem)
        QtCore.QMetaObject.connectSlotsByName(goi_mon_kem)

    def retranslateUi(self, goi_mon_kem):
        _translate = QtCore.QCoreApplication.translate
        goi_mon_kem.setWindowTitle(_translate("goi_mon_kem", "MainWindow"))
        self.check.setText(_translate("goi_mon_kem", "Hóa Đơn"))
        self.exit.setText(_translate("goi_mon_kem", "Đăng Xuất"))
        self.main.setText(_translate("goi_mon_kem", "Trang chủ"))
        self.account.setText(_translate("goi_mon_kem", "Tài Khoản"))
        self.food.setText(_translate("goi_mon_kem", "Gọi Món"))
        self.menu.setText(_translate("goi_mon_kem", "MENU"))
        self.loai_cafe.setText(_translate("goi_mon_kem", "Cafe"))
        self.loai_tra_sua.setText(_translate("goi_mon_kem", "Trà Sữa"))
        self.loai_tra_hoa_qua.setText(_translate("goi_mon_kem", "Trà Hoa Quả"))
        self.loai_kem.setText(_translate("goi_mon_kem", "Kem"))
        self.label_3.setText(_translate("goi_mon_kem", "Tên món"))
        self.label_4.setText(_translate("goi_mon_kem", "Số Lượng"))
        self.label.setText(_translate("goi_mon_kem", "Tổng : "))
        self.kem_oc_que.setText(_translate("goi_mon_kem", "Kem ốc Quế\n"
"\n"
"10.000"))
        self.kem_socola.setText(_translate("goi_mon_kem", "Kem socola\n"
"\n"
"20.000"))
        self.kem_dau.setText(_translate("goi_mon_kem", "Kem dâu\n"
"\n"
"20.000"))
        self.kem_vani.setText(_translate("goi_mon_kem", "Kem vani\n"
"\n"
"20.000"))
...
if __name__ == "__main__":
    ...
    goi_mon_kem = QtWidgets.QMainWindow()
    ui = Ui_goi_mon_kem()
    ui.setupUi(goi_mon_kem)
    goi_mon_kem.show()
    sys.exit(app.exec_())
