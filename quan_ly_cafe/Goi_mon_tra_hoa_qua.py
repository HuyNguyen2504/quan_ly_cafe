...
# Form implementation generated from reading ui file 'Goi_mon_tra_hoa_qua.ui'
#
...
class Ui_goi_mon_tra_hoa_qua(object):
    def setupUi(self, goi_mon_tra_hoa_qua):
        goi_mon_tra_hoa_qua.setObjectName("goi_mon_tra_hoa_qua")
        goi_mon_tra_hoa_qua.resize(1031, 811)
        self.centralwidget = QtWidgets.QWidget(goi_mon_tra_hoa_qua)
...
"border-left-color: rgb(0, 0, 0);")
        ...
        self.tra_dao_cam_sa = QtWidgets.QPushButton(self.groupBox)
        self.tra_dao_cam_sa.setGeometry(QtCore.QRect(350, 0, 141, 131))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.tra_dao_cam_sa.setFont(font)
        self.tra_dao_cam_sa.setObjectName("tra_dao_cam_sa")
        self.tra_o_long = QtWidgets.QPushButton(self.groupBox)
        self.tra_o_long.setGeometry(QtCore.QRect(490, 0, 141, 131))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.tra_o_long.setFont(font)
        self.tra_o_long.setObjectName("tra_o_long")
        self.tra_chanh = QtWidgets.QPushButton(self.groupBox)
        self.tra_chanh.setGeometry(QtCore.QRect(350, 130, 141, 131))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.tra_chanh.setFont(font)
        self.tra_chanh.setObjectName("tra_chanh")
        self.tra_quat = QtWidgets.QPushButton(self.groupBox)
        self.tra_quat.setGeometry(QtCore.QRect(490, 130, 141, 131))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.tra_quat.setFont(font)
        self.tra_quat.setObjectName("tra_quat")
        self.line_3.raise_()
        ...
        self.tra_dao_cam_sa.raise_()
        self.tra_o_long.raise_()
        self.tra_chanh.raise_()
        self.tra_quat.raise_()
        goi_mon_tra_hoa_qua.setCentralWidget(self.centralwidget)

        self.retranslateUi(goi_mon_tra_hoa_qua)
        QtCore.QMetaObject.connectSlotsByName(goi_mon_tra_hoa_qua)

    def retranslateUi(self, goi_mon_tra_hoa_qua):
        _translate = QtCore.QCoreApplication.translate
        goi_mon_tra_hoa_qua.setWindowTitle(_translate("goi_mon_tra_hoa_qua", "MainWindow"))
        self.check.setText(_translate("goi_mon_tra_hoa_qua", "Hóa Đơn"))
        self.exit.setText(_translate("goi_mon_tra_hoa_qua", "Đăng Xuất"))
        self.main.setText(_translate("goi_mon_tra_hoa_qua", "Trang chủ"))
        self.account.setText(_translate("goi_mon_tra_hoa_qua", "Tài Khoản"))
        self.food.setText(_translate("goi_mon_tra_hoa_qua", "Gọi Món"))
        self.menu.setText(_translate("goi_mon_tra_hoa_qua", "MENU"))
        self.loai_cafe.setText(_translate("goi_mon_tra_hoa_qua", "Cafe"))
        self.loai_tra_sua.setText(_translate("goi_mon_tra_hoa_qua", "Trà Sữa"))
        self.loai_tra_hoa_qua.setText(_translate("goi_mon_tra_hoa_qua", "Trà Hoa Quả"))
        self.loai_kem.setText(_translate("goi_mon_tra_hoa_qua", "Kem"))
        self.label_3.setText(_translate("goi_mon_tra_hoa_qua", "Tên món"))
        self.label_4.setText(_translate("goi_mon_tra_hoa_qua", "Số Lượng"))
        self.label.setText(_translate("goi_mon_tra_hoa_qua", "Tổng : "))
        self.tra_dao_cam_sa.setText(_translate("goi_mon_tra_hoa_qua", "Trà Đào Cam Sả\n"
"\n"
"20.000"))
        self.tra_o_long.setText(_translate("goi_mon_tra_hoa_qua", "Trà ô long\n"
"\n"
"15.000"))
        self.tra_chanh.setText(_translate("goi_mon_tra_hoa_qua", "Trà Chanh\n"
"\n"
"15.000"))
        self.tra_quat.setText(_translate("goi_mon_tra_hoa_qua", "Trà Quất\n"
"\n"
"15.000"))
...
if __name__ == "__main__":
    ...
    goi_mon_tra_hoa_qua = QtWidgets.QMainWindow()
    ui = Ui_goi_mon_tra_hoa_qua()
    ui.setupUi(goi_mon_tra_hoa_qua)
    goi_mon_tra_hoa_qua.show()
    sys.exit(app.exec_())
