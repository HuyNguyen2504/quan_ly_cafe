...
# Form implementation generated from reading ui file 'Goi_mon.ui'
#
...
class Ui_goi_mon(object):
    def setupUi(self, goi_mon):
        goi_mon.setObjectName("goi_mon")
        goi_mon.resize(1031, 811)
        self.centralwidget = QtWidgets.QWidget(goi_mon)
...
"background-color: rgb(85, 255, 255);")
        ...
        self.loai_cafe.setStyleSheet("border-color: rgb(0, 0, 0);\n"
...
"border-left-color: rgb(0, 0, 0);")
        ...
        goi_mon.setCentralWidget(self.centralwidget)

        self.retranslateUi(goi_mon)
        QtCore.QMetaObject.connectSlotsByName(goi_mon)

    def retranslateUi(self, goi_mon):
        _translate = QtCore.QCoreApplication.translate
        goi_mon.setWindowTitle(_translate("goi_mon", "MainWindow"))
        self.check.setText(_translate("goi_mon", "Hóa Đơn"))
        self.exit.setText(_translate("goi_mon", "Đăng Xuất"))
        self.main.setText(_translate("goi_mon", "Trang chủ"))
        self.account.setText(_translate("goi_mon", "Tài Khoản"))
        self.food.setText(_translate("goi_mon", "Gọi Món"))
        self.menu.setText(_translate("goi_mon", "MENU"))
        self.loai_cafe.setText(_translate("goi_mon", "Cafe"))
        self.loai_tra_sua.setText(_translate("goi_mon", "Trà Sữa"))
        self.loai_tra_hoa_qua.setText(_translate("goi_mon", "Trà Hoa Quả"))
        self.loai_kem.setText(_translate("goi_mon", "Kem"))
        self.label_3.setText(_translate("goi_mon", "Tên món"))
        self.label_4.setText(_translate("goi_mon", "Số Lượng"))
        self.label.setText(_translate("goi_mon", "Tổng : "))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    goi_mon = QtWidgets.QMainWindow()
    ui = Ui_goi_mon()
    ui.setupUi(goi_mon)
    goi_mon.show()
    sys.exit(app.exec_())
