...
"background-color: rgb(0, 255, 255);")
        ...
        self.user = QtWidgets.QPushButton(self.thong_ke_gr)
        self.user.setGeometry(QtCore.QRect(30, 470, 171, 81))
        font = QtGui.QFont()
        font.setPointSize(12)
...
"background-color: rgb(189, 189, 189);")
    ...
    def retranslateUi(self, man_hinh_quan_ly_hoa_don):
        ...
        man_hinh_quan_ly_hoa_don.setWindowTitle(_translate("man_hinh_quan_ly_hoa_don", "MainWindow"))
        ...
        self.user.setText(_translate("man_hinh_quan_ly_hoa_don", "Người Dùng"))
